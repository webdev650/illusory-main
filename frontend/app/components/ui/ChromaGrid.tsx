...
export const ChromaGrid: React.FC<ChromaGridProps> = ({
  ...
  const demo: ChromaItem[] = [
    {
      ...
      description:
        "Our social media was directionless until Illusory took over. They didn’t just manage pages — they gave our travel brand a voice, rhythm, and personality. What impressed me most was their consistency and control — even under tight deadlines, they delivered with excellence.",
      borderColor: "#4F46E5",
    ...
    },
    {
      ...
      description:
        "What set Illusory apart was how deeply they understood the soul of my brand. They didn’t just deliver designs — they created a visual language that matched my energy and vision.",
      borderColor: "#10B981",
  ...
  // Seamless loop quadruplication back-to-back
  const repeatedData = [...baseData, ...baseData, ...baseData, ...baseData];
  ...
  return (
    ...
    >
      {/* Edge-to-Edge Side Gradient Fade Masks */}
      ...
      {/* Infinite Marquee Scrolling Track */}
      <div
        className="chroma-marquee-track"
        style={{ animationDuration: speed }}
      >
        {repeatedData.map((c, i) => (
          <article
            key={`${c.title}-${i}`}
          ...
          >
            ...
            <footer className="chroma-info">
              ...
              <p
                className="line-clamp-3 description-tooltip"
      ...
      {tooltip.show && (
        <div
          className="bg-neutral-800 max-w-md p-4 rounded-xl text-xs sm:text-sm text-white shadow-2xl border border-white/10"
          style={{
            position: "fixed",
            left: `${tooltip.x}px`,
            top: `${tooltip.y}px`,
